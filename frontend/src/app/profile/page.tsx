  ...
  return (
    <div className=" min-h-screen bg-white">
      <Header />
       ...
       <button className='bg-blue-900 rounded-md p-2 px-3 mb-4 text-white'>Profile</button>
      <div className="flex flex-col md:flex-row md:gap-5">
        ...
        <div className="mb-4">
          ...
          <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-1" htmlFor="Wallet ID">
              Wallet ID
            </label>
            <input disabled className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Wallet ID" />
            </div>
            <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-1" htmlFor="username">
              Mobile Number
            </label>
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Phone Number" />
            </div>
        </div>
        ...
        <div className="flex-1">
          <div className="mb-4">
            {/* Profile image */}
            <label className="block text-gray-700 text-md font-bold mb-1" htmlFor="Wallet ID">
              Profile Pic
            </label>
      ...
      <button className='bg-blue-900 rounded-md p-2 px-3 mb-4 text-white'>Update Profile</button>
    </div>
    </div>
  );
}
