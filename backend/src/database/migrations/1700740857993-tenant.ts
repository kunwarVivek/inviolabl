...
export class Tenant1700740857993 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_users_tenants_tenant_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "tenants" ADD "phone" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "tenants" ADD CONSTRAINT "UQ_da4054294eaae43ec7f85b6a3a1" UNIQUE ("domain")`);
        ...
        await queryRunner.query(`ALTER TABLE "tenant_settings" ADD CONSTRAINT "FK_a6abc1c3ed0df635955fc852f1c" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tenants" DROP CONSTRAINT "UQ_da4054294eaae43ec7f85b6a3a1"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_users_tenants_tenant_id" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
